...
namespace WPFAppWithDocFxAndLogging1
{
    ...
    /// </item>
    /// <item>
    /// <description><b>Code Change Date and Time:</b><para>Sunday, November 8, 2020 11:55 AM</para><b>Code Changes:</b><para>Created XML Comment</para></description>
    /// </item>
    /// </list>
    /// </remarks>
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            //string name = nameof(WPFAppWithDocFxAndLogging1);
            ...
            Logger = Factory.CreateLogger($"{logFileName}_{nameof(WPFAppWithDocFxAndLogging1)}");
