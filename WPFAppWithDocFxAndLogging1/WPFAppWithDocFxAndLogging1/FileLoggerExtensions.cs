//***********************************************************************
// Assembly         : WPFAppWithDocFxAndLogging1
...
namespace WPFAppWithDocFxAndLogging1
{
    ...
    /// </item>
    /// <item>
    /// <description><b>Code Change Date and Time:</b><para>Sunday, November 8, 2020 11:58 AM</para><b>Code Changes:</b><para>Created XML Comment</para></description>
    /// </item>
    /// </list>
    /// </remarks>
    public static class FileLoggerExtensions
    {
        ...
        {
            logger.Log(logLevel: logLevel, eventId: 0, exception: null, message: message, args: args);
        }
        ...
        public static void Log(this ILogger logger, LogLevel logLevel, Exception exception, string message, bool includeStackTrace = false, params object[] args)
        {
            ...
            {
                message = message + $"{Environment.NewLine}Stack Trace: {exception.StackTrace}";
            }
        ...
        [CallerLineNumber] int callerLineNumber = 0)
        {
            ...
            {
                message = message + $"{Environment.NewLine}Project Source: {exception.Source}{Environment.NewLine}Caller Member Name: {callerMemberName}{Environment.NewLine}Caller File Path: {callerFilePath}{Environment.NewLine}Caller Line Number: {callerLineNumber}";
            }
        ...
        [CallerLineNumber] int callerLineNumber = 0)
        {
            if (callerMemberName != "" && includeLineInfo != false)
            {
                message = message + $"{Environment.NewLine}Caller Member Name: {callerMemberName}{Environment.NewLine}Caller File Path: {callerFilePath}{Environment.NewLine}Caller Line Number: {callerLineNumber}";
            }
